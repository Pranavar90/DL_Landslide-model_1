...
```
bibtex
@software{landslide_susceptibility_2025,
  title={Landslide Susceptibility Mapping using Deep Learning and Google Earth Engine},
  author={Pranav A R},
  year={2025},
  url={https://github.com/Pranavar90/landslide-susceptibility-mapping}
}
```
📧 Contact
...
**This project is developed solely for research and education purposes.** It is a proof-of-concept demonstration of applying deep learning technniques to geospataial and remote sensing and should **NOT** be used for :  

- Operational Landlside prediction or monitoring
- Emergency response planning
- Real estate or insurance risk assessment
- Public safety decision-making
- Infrastructure planning without expert validation
- Any commercial applications without extensive validation

### Critical Limitations

This model uses synthetic lithology and previous map data for training / demonstration purposes. 

Note: This is a research/educational project. For operational landslide monitoring, please consult with geological experts and use validated models with ground-truth data Landslide Susceptibility Mapping using Deep Learning and Google Earth Engine
